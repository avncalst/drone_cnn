...
def drive(cfg, model_path=None, use_joystick=False, model_type=None, camera_type='single', meta=[] ):
    ...
    if model_path:
        ...
        if '.h5' in model_path or '.uff' in model_path or 'tflite' in model_path or '.pkl' in model_path or '.pb' in model_path:
...
##            print(mode)
    ...
    #Drive train setup
    print('drive train:',cfg.DRIVE_TRAIN_TYPE)
    if cfg.DONKEY_GYM:
        pass
...
if __name__ == '__main__':
    ...
    # drive(cfg,model_path='c:\\Users\\UGent\\Dropbox\\donkeycar\\mycar\\models\\test1.pb')
